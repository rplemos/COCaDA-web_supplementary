...
with open(f"/hd/cocada-web_update/missing_ids/missing_ids_{today}.txt", "r") as file:
...
pdb_list.download_pdb_files(pdb_codes, pdir=f"/hd/cocada-web_update/new_files/new_files_{today}", overwrite=False)
